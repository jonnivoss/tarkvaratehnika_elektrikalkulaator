...
{
    [TestClass]
    public class UnitTestArvutajaLargestIntegral
    {
        ...
        public void TyypilisedAndmed()
        {
            ...
            double integraal;
            System.DateTime subOptimalDate;

            int reaalne1 = objekt.largestIntegral(andmed, 1.0, 4.1, alumineRaja, ylemineRaja, out integraal, out subOptimalDate);
            int oodatud1 = 0;
            double reaalne2 = integraal;
            double oodatud2 = 18.708;
            DateTime reaalne3 = subOptimalDate;
            DateTime oodatud3 = new System.DateTime(2023, 03, 10, 8, 0, 0);
        ...
        public void YksTund()
        {
            ...
            int reaalne1 = objekt.largestIntegral(andmed, 1.0, 1.1, alumineRaja, ylemineRaja, out integraal, out subOptimalDate);
            int oodatud1 = 0;
            double reaalne2 = integraal;
        ...
        public void V6rdsedRajad()
        {
            ...
            int reaalne1 = objekt.largestIntegral(andmed, 1.0, 1.0, alumineRaja, ylemineRaja, out integraal, out subOptimalDate);
            int oodatud1 = 2;
            double reaalne2 = integraal;
            double oodatud2 = Double.PositiveInfinity;
            Assert.AreEqual(oodatud1, reaalne1);
        ...
        public void TyhjadAndmed()
        {
            ...
            int reaalne1 = objekt.largestIntegral(andmed, 0.0, 0.0, alumineRaja, ylemineRaja, out integraal, out subOptimalDate);
            int oodatud1 = 2;
            double reaalne2 = integraal;
            double oodatud2 = Double.PositiveInfinity;
            Assert.AreEqual(oodatud1, reaalne1);
        ...
        public void TarbiminePikemKuiRajad()
        {
            ...
            int reaalne1 = objekt.largestIntegral(andmed, 1.0, 2.1, alumineRaja, ylemineRaja, out integraal, out subOptimalDate);
            int oodatud1 = 2;
            double reaalne2 = integraal;
            double oodatud2 = Double.PositiveInfinity;
